...
const Apple = () => {
  const images = [
    "https://i.ibb.co/vZ5MXwW/Apple-Products-2.png",
    "https://i.ibb.co/THKgmD7/Apple-Products-1.png",
    "https://i.ibb.co/9HXM9c5/Apple-Products-3.png",
  ];
  const [data, setData] = useState([]);
  useEffect(() => {
    fetch(
      `https://b8-a10-server-ptdsh54sf-xdevimran.vercel.app/products/brand/Apple`
    )
      .then((res) => res.json())
