...
const Google = () => {
  const images = [
    "https://i.ibb.co/0yfKRDy/2.png",
    "https://i.ibb.co/yS8hbg2/3.png",
    "https://i.ibb.co/BwFq1KB/1.png",
  ];
  const [data, setData] = useState([]);

  useEffect(() => {
    fetch(
      `https://b8-a10-server-ptdsh54sf-xdevimran.vercel.app/products/brand/Google`
    )
      .then((res) => res.json())
