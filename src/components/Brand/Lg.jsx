...
const Lg = () => {
  const images = [
    "https://i.ibb.co/rG3Np56/2.png",
    "https://i.ibb.co/GMfT3q2/3.png",
    "https://i.ibb.co/RHFQts9/1.png",
  ];
  const [data, setData] = useState([]);
  useEffect(() => {
    fetch(
      `https://b8-a10-server-ptdsh54sf-xdevimran.vercel.app/products/brand/Lg`
    )
      .then((res) => res.json())
